...
//$dump["xxxxx1"] = ExportField("address_alias", "address", 0, 2);
//$dump["xxxxx2"] = ExportField("address_alias", "alias", 1, 0);
//$dump["xxxxx2"] = ExportField("building_address", "address", 0, 2);

//$dump["address_elem_map_x"] = ExportField("address_elem", "map_x", 0, 10);
//$dump["address_elem_map_y"] = ExportField("address_elem", "map_y", 0, 10);
...
//$dump["rub3_keyword_rub3"] = ExportField("rub3_keyword", "rub3", 0, 2);
//$dump["rub3_keyword_kwd"] = ExportField("rub3_keyword", "kwd", 1, 0);
...
//$dump["phone"] = ExportField("fil_contact", "ph_format", 0, 1);
//$dump["phone"] = ExportField("fil_contact", "type", 0, 2);
//$dump["phone"] = ExportField("fil_contact", "grpname", 1, 3);
//$dump["phoneformat"] = ExportField("phone_format", "format");
//$dump["city_type"] = ExportField("city_type", "name", 1);
//$dump["rub3alias"] = ExportField("rub3_alias", "alias");
//$dump["rub3alias_rub3"] = ExportField("rub3_alias", "rub3", 0, 2);
...
//foreach($dump["rub3_keyword_rub3"] As $key=>$val) {
//	$dump["rub3_keywords"][$val][] = $dump["rub3_keyword_kwd"][$key];
//}
//unset($dump["rub3_keyword_rub3"]);
...
//cli_set_process_title(rtrim($srcfolder,"/").".xlsx");
...
/*
	$allrubs = file("rub3", FILE_IGNORE_NEW_LINES);

	foreach($rubs3 as $tyu)
	{
		if((array_search($tyu,$allrubs,true)!==false))
		{
			goto sss;
		}
	}
